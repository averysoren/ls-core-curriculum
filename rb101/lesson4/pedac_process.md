...
## P: Understading the Problem

- Establish the rules/ define the boundaries of the problem
  - Assess available information
  - Restate Explicit requirements
  - Identify Implicity requirements
...
integers, and so on. Given an integer representing the number of a partciular row, return an 
...
- Be prepared to move back and forth between the steps in the process
