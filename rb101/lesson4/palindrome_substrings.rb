...
# Empty strings as input should return an empty array

# Can I assume all inputs are strings?

# 2 or more repeating letters constitutes a palindrome
...
#       
#       Implicit:
#         - If the string is empty, the result should be an empty array
...
# Algorithm for substring method
...
# Formal Pseudocode for substring method
